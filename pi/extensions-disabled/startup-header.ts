...
/** Theme colors for the caption. Any color name from the theme works. */
const TAGLINE_COLOR = "accent"; // mauve, matches the logo gradient
const TAGLINE_HIGHLIGHT_COLOR = "accent"; // same as the rest of the caption
...
function renderTaglineLines(
  ...
  const line1 = createCenteredStyledLine(
    [{ raw: TAGLINE_LINE_1, styled: theme.fg(TAGLINE_COLOR, TAGLINE_LINE_1) }],
    width,
  );
    ...
    [
      {
        ...
        styled: theme.fg(TAGLINE_COLOR, TAGLINE_LINE_2_PREFIX),
      },
      {
        raw: TAGLINE_LINE_2_HIGHLIGHT,
        styled: theme.fg(TAGLINE_HIGHLIGHT_COLOR, TAGLINE_LINE_2_HIGHLIGHT),
      },
      {
        raw: TAGLINE_LINE_2_SUFFIX,
        styled: theme.fg(TAGLINE_COLOR, TAGLINE_LINE_2_SUFFIX),
      },
    ],
    width,
  );
